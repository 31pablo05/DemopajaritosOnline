...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      title: '¿Tiene talles?',
      type: 'boolean',
      description: 'Activalo para ropa. Desactivalo para loncheras, almohadones, cubrecamas, etc.',
      initialValue: true,
    },
    {
      name: 'sizes',
      ...
      type: 'array',
      of: [{ type: 'string' }],
      hidden: ({ document }) => !document?.hasSizes,
      options: {
        list: [
  ...
  preview: {
    ...
    prepare({ title, media, subtitle }) {
      return { title, media, subtitle: subtitle || 'Sin categoría' }
    },
  },
}
